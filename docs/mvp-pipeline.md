...
pixi run driftless-star-fwd --configfile inputs/quick_run/config.yaml --cores 4      # full forward pass through Stage 5 (Stages 2 and 3 run in parallel after Stage 1; Stage 4 follows Stage 2)
